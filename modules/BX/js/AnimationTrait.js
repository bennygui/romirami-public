...
define([
    ...
    function (dojo, declare) {
        return declare("bx.AnimationTrait", null, {
            ...
            slide(mobileElt, targetElt, options = {}) {
                ...
                if (!config.destroy && config.pos === null && mobile.parentNode == targetElt && config.beforeBrother === null) {
            ...
            wait(delay, isInstantaneous = false) {
                if (delay <= 0 || isInstantaneous || this.isFastMode()) {
                    return Promise.resolve();
                }
                return new Promise((resolve, reject) => {

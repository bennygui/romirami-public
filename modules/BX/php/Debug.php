...
trait GameStatesTrait
{
    ...
    {
        return [
            "UPDATE bx_action_command SET action_json = REPLACE(action_json, '\"playerId\":$replacePlayerId', '\"playerId\":$studioPlayerId') WHERE action_json like '%\"playerId\":$replacePlayerId%'"
        ];
    }
